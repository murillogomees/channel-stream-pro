...
export function AnimatedSplash({
  ...
  return <div className={cn('fixed inset-0 z-50 flex flex-col items-center justify-center bg-background', 'transition-opacity duration-500', fadeOut && 'opacity-0')}>
      {/* Logo Animation */}
      ...
      <div className="w-48 h-1 bg-muted rounded-full overflow-hidden mb-4">
        <div className="h-full bg-primary transition-all duration-100 ease-out" style={{
        width: `${progress}%`
      }} />
      </div>
